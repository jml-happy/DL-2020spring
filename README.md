...
1. Introduction to Python and Numpy  
    ...
    4. If you already have some Python and Numpy background, I suggest practicing these:   
        a. [From Python to Numpy](https://www.labri.fr/perso/nrougier/from-python-to-numpy/)   
        b. [100 numpy exercises](https://github.com/rougier/numpy-100/blob/master/100_Numpy_exercises.ipynb) by Nicolas P. Rougier  
